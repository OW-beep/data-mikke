...
export const forestRateCrimeRateCorrelation: Article = {
  ...
  body: [
    ...
    "n=47という都道府県単位のサンプルサイズでは、こうした相関から個々の要因を厳密に切り分けることはできません。それでも、単純な2変数の相関係数を計算するだけで、一見無関係に思える指標同士のつながりや、その裏にある共通の構造が見えてくるのは、都道府県データを読み解く面白さの一つです。当サイトの犯罪発生率・人口密度のダッシュボードとあわせて、自分の県がどのあたりに位置するか確認してみてください。"
  ]
};
