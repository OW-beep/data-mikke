...
export const michinoekiHokkaidoVsTokyoOneStation: Article = {
  ...
  body: [
    ...
    "地方ブロック単位で平均を見ても、この傾向ははっきりしています。東北6県の道の駅数の平均は約29駅、中部・北陸9県の平均も約31駅と、地方部のブロックはおおむね横並びで多い一方、関東7都県（茨城・栃木・群馬・埼玉・千葉・東京・神奈川）の平均は約19駅まで落ち込みます。しかもこの関東平均は、東京都（1駅）・神奈川県（4駅）を除いた残り5県だけで見るとさらに数値が押し上げられる構造で、道の駅は特定の1県が突出しているというより地方の各ブロックに満遍なく整備されているインフラであり、その対極に東京都・神奈川県という大都市圏が位置している、という構図が見えてきます。"
  ]
};
