...
export const birthrateSmallestGapOkinawaTokyo: Article = {
  ...
  title: "出生率ランキング、1位は沖縄県(1.54)・最下位は東京都(0.96)。47都道府県の差はわずか1.6倍",
  excerpt:
    "都道府県別の出生率ランキング（合計特殊出生率）は、1位・沖縄県(1.54)、最下位・東京都(0.96)。面積は44倍、生乳生産量は13倍の差があった当サイトの他の指標と比べても、1位と最下位の差が約1.6倍と意外なほど小さい指標です。",
  ...
  body: [
    "2024年の合計特殊出生率（1人の女性が生涯に産む子どもの数の推計値）を都道府県別の出生率ランキングで見ると、沖縄県が1.54で全国トップ、最下位は東京都の0.96でした。東京都は都道府県の中で唯一1.0を下回っています。この2つの数字だけを見れば「沖縄は出生率が高く、東京は低い」という、よく言われる傾向どおりの結果です。ただし、この記事で注目したいのは1位と最下位そのものではなく、「差の小ささ」です。",
