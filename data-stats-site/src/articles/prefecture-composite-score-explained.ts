...
export const prefectureCompositeScoreExplained: Article = {
  ...
  body: [
    ...
    "スコアは、県民所得・人口10万人あたり病院数・持ち家比率・年少人口割合・高齢化率という5つの指標について、それぞれ全国平均と比べて「良い方向」にあるかどうかを数えたものです。県民所得・病院数・持ち家比率・年少人口割合は数値が高いほど加点、高齢化率は数値が低いほど加点としています。5つのうち、良い方向にある指標の数がそのままスコアになります。",
