...
export const universityPerCapitaKyotoTop: Article = {
  ...
  embedRanking: "universityPerCapita",
  relatedArticles: ["university-count-tokyo-concentration-history", "cafe-count-nagano-hidden-kingdom"],
  body: [
    "大学数の総数だけを見れば、東京都が139校で圧倒的な1位です。しかし、これを人口10万人あたりに調整すると、順位は大きく入れ替わります。人口約880万人を抱える東京都は、大学数こそ多いものの、人口で割ると相対的に薄まり、代わって京都府が全国トップに立ちます。",
