...
import { manualNurseProvider } from "./manual/nurse";
import { manualFishProvider } from "./manual/fish";
...
import { manualRentProvider } from "./manual/rent";
import { manualSunshineProvider } from "./manual/sunshine";
import { manualForestProvider } from "./manual/forest";
...
export const PROVIDERS: Record<string, Provider> = {
  ...
  "manual-nurse": manualNurseProvider,
  "manual-fish": manualFishProvider,
  ...
  "manual-rent": manualRentProvider,
  "manual-sunshine": manualSunshineProvider,
  "manual-forest": manualForestProvider,
