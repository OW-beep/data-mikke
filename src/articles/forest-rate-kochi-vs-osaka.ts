...
export const forestRateKochiVsOsaka: Article = {
  ...
  title: "森林率ランキング、1位は高知県83.8%・最下位は大阪府30.0%。国土の見え方は県によってまるで違う",
  excerpt:
    "都道府県別の森林率ランキングは、1位・高知県83.8%から最下位・大阪府30.0%まで、50ポイント以上の開きがあります。所得との相関はゆるやかな負の関係でした。",
  publishedAt: "2026-07-23",
  relatedDataset: "forest",
  embedRanking: "forest",
  relatedArticles: [
    "population-density-meaning",
    "agriculture-fisheries-income-stereotype-busted",
    "forest-rate-crime-rate-correlation",
    "prefecture-archetypes-pca-clustering-analysis"
  ],
  body: [
    "高知県を車で走ると、平地よりも山と森の景色のほうがずっと長く続きます。この体感は数字にもそのまま表れていて、都道府県別の森林率ランキング（国土面積に占める森林面積の割合）を見ると、最も高いのは高知県の83.8%です。次いで岐阜県（81.2%）、長野県（78.8%）、島根県（78.2%）、山梨県（77.9%）と、四国山地や中部・中国地方の山がちな県が上位を占めます。逆に最も低いのは大阪府の30.0%で、千葉県（30.5%）、茨城県（30.6%）が続きます。同じ日本国内でも、県土の8割以上が森林の県から、3割程度しかない県まで、50ポイント以上の開きがあることになります。",
