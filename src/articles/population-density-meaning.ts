...
export const populationDensityMeaning: Article = {
  ...
  body: [
    ...
    "当サイトが複数の指標の変動係数（都道府県間のばらつきの大きさ）を計算したところ、人口密度の変動係数は1.878と、他のどの指標よりも突出して大きいという結果になりました。県民所得の変動係数が0.153、持ち家比率が0.109にとどまるのと比べると、人口密度がいかに都道府県によって桁違いの差を持つ指標かが分かります。この極端なばらつきの大きさゆえに、人口密度は当サイトの他の多くの指標と相関しやすい性質を持っています。実際、県民所得（r=0.654）、犯罪発生件数（r=0.528）、持ち家比率（r=-0.589）、都市公園面積（r=-0.542）、自動車所有率（r=-0.747）と、性質の異なる指標のいずれとも無視できない相関を示しており、「都市化の進み具合」を測る代理変数として機能していることがうかがえます。",
